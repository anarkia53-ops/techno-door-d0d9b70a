...
const branches = [
  ...
  { city: "الخرطوم", country: "السودان", role: "فرع إقليمي" },
  { city: "بنغازي", country: "ليبيا", role: "فرع إقليمي" },
];
    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-5 md:px-8 py-20 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-5 text-white/75 leading-loose">
          ...
          <p>توسعت أعمالنا لتشمل مشاريع ضخمة في مصر مع كبرى العلامات التجارية العالمية مثل بيبسي، مرسيدس، اتصالات، أديداس، وبي تك، بالإضافة إلى فروعنا الإقليمية في السودان (الخرطوم) وليبيا (بنغازي).</p>
