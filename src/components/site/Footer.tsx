      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8 py-14 grid gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/60">
            <li className="flex items-center gap-2"><Mail size={14} className="text-[var(--cyan)]" /><a href="mailto:admin@techno-door.com" className="hover:text-white">admin@techno-door.com</a></li>
            ...
            <li className="flex items-center gap-2"><Facebook size={14} className="text-[var(--cyan)]" /><a href="https://www.facebook.com/techhnoodoor99" className="hover:text-white">techhnoodoor99</a></li>
          </ul>
        </div>
      </div>
